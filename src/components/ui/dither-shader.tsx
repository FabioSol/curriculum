...
interface DitherShaderProps {
  ...
  /** Object position for cover/contain (0 = start, 0.5 = center, 1 = end) */
...
export const DitherShader: React.FC<DitherShaderProps> = ({
  ...
  }, [src, dimensions, objectFit, objectPositionX, objectPositionY, animated, animationSpeed, applyDithering]);
